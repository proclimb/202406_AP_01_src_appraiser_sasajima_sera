...
function fnSqlStockList($flg, $param)
{
    switch ($flg) {
        case 0:
            ...
            break;
        case 1:
            // 修正前　$select  = "SELECT STOCKNO,CHARGE,RANK,DATE_FORMAT(INSDT,'%Y/%m/%d'),ARTICLE,ARTICLEFURI,ROOM,"
...
function fnSqlStockInsert($param)
{
    ...
    // 修正前　 $sql .= "STOCKNO,CHARGE,RANK,ARTICLE,ARTICLEFURI,ROOM,AREA,STATION,DISTANCE,AGENT,STORE,COVER,VISITDT,DESKPRICE,VENDORPRICE,NOTE,HOW,INSDT,UPDT,DEL";
