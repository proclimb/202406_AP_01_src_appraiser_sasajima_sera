...
?>
	...
	<!-- 修正前 <form name="form" id="form" action="index.php" method="get"> -->
	<form name="form" id="form" action="index.php" method="post">
		...
		<table border="0" cellpadding="5" cellspacing="1">
			...
			<tr>
				...
				<td>
					...
					for ($i = 0; $i < 5; $i++) {
					?>
						<!--　修正前 <input type="radio" name="rank" value="<//?php print $i + 1; ?>" <//?php if ($param["rank"] == $i + 1) print ' checked="checked"'; ?> /> <//?php print fnRankName($i); ?> -->
			...
			<tr>
				...
				<td>
					...
					for ($i = 0; $i < 4; $i++) {
					?>
						<!-- 修正前 <input type="radio" name="distance" value="<//?php print $i + 1; ?>" <//?php if ($param["distance"] == $i + 1) print ' checked="checked"'; ?> /> <//?php print fnDistanceName($i); ?> -->
